    ...
    public class DeviceMappingProfile : Profile
    {
        public DeviceMappingProfile()
        {
            CreateMap<Gateway, Telstra.Core.Data.Entities.Device>()
                ...
                .ForMember(dest => dest.MetadataAuthSymmetricKey, opts => opts.MapFrom(s => s.Metadata.Auth.SymmetricKey));
            ...
            CreateMap<Device, Gateway>()
                ...
                .ForPath(dest => dest.Metadata.Auth.SymmetricKey, opts => opts.MapFrom(s => s.MetadataAuthSymmetricKey));
